...
totalImg = numImagesPerClass * numClasses;

% get user input
faceToMatch = input(sprintf(['Enter the face # in the database', ...
                                      'you want to find matches for', ...
                                      ', from 1 to %d (ex. 43): '],  ...
                                      totalImg));
                                  
while ~(isreal(faceToMatch) && rem(faceToMatch,1)==0) || ...
       (faceToMatch < 1 || faceToMatch > totalImg)
